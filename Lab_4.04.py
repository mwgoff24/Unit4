...
def print_item():
    list_choice = input("What list would you like to choose, 1, 2, or 3? ")
    item_choice = input("What item would you like to choose, 1, 2, or 3? ")
    print(shopping_lists[int(list_choice)-1][int(item_choice)-1])
    

def print_list():
    list_choice = input("What list would you like to choose, 1, 2, or 3? ")
    print(shopping_lists[int(list_choice)-1])
